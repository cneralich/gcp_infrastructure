...
module "compute_instance" {
  source  = "app.terraform.io/terraform-pmr-demo/compute-instance/google"
  version = "0.1.3"
...
module "network_firewall" {
  source  = "app.terraform.io/terraform-pmr-demo/network-firewall/google"
  version = "0.1.5"

  description = "demo-firewall-rule"
  name = "demo-firewall-rule"
...
module "network_subnet" {
  source  = "app.terraform.io/terraform-pmr-demo/network-subnet/google"
  version = "0.1.2"
...
module "network" {
  source  = "app.terraform.io/terraform-pmr-demo/network/google"
  version = "0.1.3"

  auto_create_subnetworks = "false"
  description = "Corrigan's Demo Network"
  name = "demo-network"
}
